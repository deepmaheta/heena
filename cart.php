								...
								<tr>
									...
									?>
										<td class="product-thumbnail">
											<img src="./image/product/<?php echo $subrow['productimage'] ?>" alt="Image" class="img-fluid">
										</td>
										...
										<td>
											<div class="input-group mb-3 d-flex align-items-center quantity-container" style="max-width: 120px;">
												...
												<input type="text" readonly class="form-control text-center quantity-amount" value="1" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
												
											</div>

										</td>
										<td><?php echo number_format($subrow['productprice']) ?>₹</td>
										<td><a href="removetocart.php?cartid=<?php echo $row['ID'] ?>" class="btn btn-black btn-sm">X</a></td>
								</tr>
							<?php
									}
							?>
						...
						<div class="col-md-7">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									<strong class="text-black"><?php echo $p ?></strong>
								</div>
							</div>
							<div class="row mb-5">
								<div class="col-md-6">
